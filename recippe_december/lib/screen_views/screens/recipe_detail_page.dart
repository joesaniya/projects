...
import 'package:recippe_december/screen_views/apptheme/AppColor.dart';
      ...
      appBar: PreferredSize(
        ...
        child: AnimatedContainer(
          ...
          child: AppBar(
            ...
            elevation: 0,
            centerTitle: true,
            title: Text('Recipe Details', style: TextStyle(fontFamily: 'inter', fontWeight: FontWeight.w400, fontSize: 16)),
            leading: IconButton(
