...
class _homeState extends State<home> {
  ...
  Widget build(BuildContext context) {
   return Scaffold(
          ...
          return ListView(
            ...
            .map((user) => Card(
              child: ListTile(
                    ...
                    //   print(user.name); 
                    // },
                    subtitle: Text(user.date.toString(),style: TextStyle(fontSize: 30),),
                    trailing: Icon(Icons.arrow_forward),
      ...
      //       builder: (context, snapshot) {
      //         if (snapshot.hasData) {
      //           List<States>? data = snapshot.data;
      //           return 
      //           ListView.builder(
      ...
      //                 height: 75,
      //                 color: Colors.red,
      //                 child: Center(child: Text(data[index].state,style: TextStyle(color: Colors.black),),
      //               ),),
      //             );
      //           }
      //         );
...
//                     //   print(states.state); 
//                     // },
//                     subtitle: Text(j.probableCases.toString(),style: TextStyle(fontSize: 18),),
//                     trailing: Icon(Icons.arrow_forward),
//                   ),
//             ),
//               )
